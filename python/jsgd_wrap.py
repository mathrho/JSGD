...
class jsgd_params_t(_object):
    ...
    __swig_setmethods__["eta_nepoch"] = _jsgd_wrap.jsgd_params_t_eta_nepoch_set
    __swig_getmethods__["eta_nepoch"] = _jsgd_wrap.jsgd_params_t_eta_nepoch_get
    if _newclass:eta_nepoch = _swig_property(_jsgd_wrap.jsgd_params_t_eta_nepoch_get, _jsgd_wrap.jsgd_params_t_eta_nepoch_set)
    ...
    __swig_setmethods__["avg"] = _jsgd_wrap.jsgd_params_t_avg_set
    __swig_getmethods__["avg"] = _jsgd_wrap.jsgd_params_t_avg_get
    if _newclass:avg = _swig_property(_jsgd_wrap.jsgd_params_t_avg_get, _jsgd_wrap.jsgd_params_t_avg_set)
    __swig_setmethods__["rho"] = _jsgd_wrap.jsgd_params_t_rho_set
    __swig_getmethods__["rho"] = _jsgd_wrap.jsgd_params_t_rho_get
    if _newclass:rho = _swig_property(_jsgd_wrap.jsgd_params_t_rho_get, _jsgd_wrap.jsgd_params_t_rho_set)
    ...
    __swig_setmethods__["temperature"] = _jsgd_wrap.jsgd_params_t_temperature_set
    __swig_getmethods__["temperature"] = _jsgd_wrap.jsgd_params_t_temperature_get
    if _newclass:temperature = _swig_property(_jsgd_wrap.jsgd_params_t_temperature_get, _jsgd_wrap.jsgd_params_t_temperature_set)
    __swig_setmethods__["fine_tune_bias"] = _jsgd_wrap.jsgd_params_t_fine_tune_bias_set
    __swig_getmethods__["fine_tune_bias"] = _jsgd_wrap.jsgd_params_t_fine_tune_bias_get
    if _newclass:fine_tune_bias = _swig_property(_jsgd_wrap.jsgd_params_t_fine_tune_bias_get, _jsgd_wrap.jsgd_params_t_fine_tune_bias_set)
    __swig_setmethods__["bias_learning_rate"] = _jsgd_wrap.jsgd_params_t_bias_learning_rate_set
    __swig_getmethods__["bias_learning_rate"] = _jsgd_wrap.jsgd_params_t_bias_learning_rate_get
    if _newclass:bias_learning_rate = _swig_property(_jsgd_wrap.jsgd_params_t_bias_learning_rate_get, _jsgd_wrap.jsgd_params_t_bias_learning_rate_set)
    __swig_setmethods__["biasopt_netas"] = _jsgd_wrap.jsgd_params_t_biasopt_netas_set
    __swig_getmethods__["biasopt_netas"] = _jsgd_wrap.jsgd_params_t_biasopt_netas_get
    if _newclass:biasopt_netas = _swig_property(_jsgd_wrap.jsgd_params_t_biasopt_netas_get, _jsgd_wrap.jsgd_params_t_biasopt_netas_set)
    __swig_setmethods__["biasopt_etafactor"] = _jsgd_wrap.jsgd_params_t_biasopt_etafactor_set
    __swig_getmethods__["biasopt_etafactor"] = _jsgd_wrap.jsgd_params_t_biasopt_etafactor_get
    if _newclass:biasopt_etafactor = _swig_property(_jsgd_wrap.jsgd_params_t_biasopt_etafactor_get, _jsgd_wrap.jsgd_params_t_biasopt_etafactor_set)
    __swig_setmethods__["biasopt_nsample_eta"] = _jsgd_wrap.jsgd_params_t_biasopt_nsample_eta_set
    __swig_getmethods__["biasopt_nsample_eta"] = _jsgd_wrap.jsgd_params_t_biasopt_nsample_eta_get
    if _newclass:biasopt_nsample_eta = _swig_property(_jsgd_wrap.jsgd_params_t_biasopt_nsample_eta_get, _jsgd_wrap.jsgd_params_t_biasopt_nsample_eta_set)
    __swig_setmethods__["biasopt_n_epoch"] = _jsgd_wrap.jsgd_params_t_biasopt_n_epoch_set
    __swig_getmethods__["biasopt_n_epoch"] = _jsgd_wrap.jsgd_params_t_biasopt_n_epoch_get
    if _newclass:biasopt_n_epoch = _swig_property(_jsgd_wrap.jsgd_params_t_biasopt_n_epoch_get, _jsgd_wrap.jsgd_params_t_biasopt_n_epoch_set)
    ...
    __swig_setmethods__["eval_objective"] = _jsgd_wrap.jsgd_params_t_eval_objective_set
    __swig_getmethods__["eval_objective"] = _jsgd_wrap.jsgd_params_t_eval_objective_get
    if _newclass:eval_objective = _swig_property(_jsgd_wrap.jsgd_params_t_eval_objective_get, _jsgd_wrap.jsgd_params_t_eval_objective_set)
    __swig_setmethods__["objectives"] = _jsgd_wrap.jsgd_params_t_objectives_set
    __swig_getmethods__["objectives"] = _jsgd_wrap.jsgd_params_t_objectives_get
    if _newclass:objectives = _swig_property(_jsgd_wrap.jsgd_params_t_objectives_get, _jsgd_wrap.jsgd_params_t_objectives_set)
    ...
    __swig_setmethods__["check_level"] = _jsgd_wrap.jsgd_params_t_check_level_set
    __swig_getmethods__["check_level"] = _jsgd_wrap.jsgd_params_t_check_level_get
    if _newclass:check_level = _swig_property(_jsgd_wrap.jsgd_params_t_check_level_get, _jsgd_wrap.jsgd_params_t_check_level_set)
    __swig_setmethods__["wavg"] = _jsgd_wrap.jsgd_params_t_wavg_set
    __swig_getmethods__["wavg"] = _jsgd_wrap.jsgd_params_t_wavg_get
    if _newclass:wavg = _swig_property(_jsgd_wrap.jsgd_params_t_wavg_get, _jsgd_wrap.jsgd_params_t_wavg_set)
    __swig_setmethods__["bavg"] = _jsgd_wrap.jsgd_params_t_bavg_set
    __swig_getmethods__["bavg"] = _jsgd_wrap.jsgd_params_t_bavg_get
    if _newclass:bavg = _swig_property(_jsgd_wrap.jsgd_params_t_bavg_get, _jsgd_wrap.jsgd_params_t_bavg_set)
    def __init__(self): 
...
JSGD_ALGO_MUL2 = _jsgd_wrap.JSGD_ALGO_MUL2
JSGD_ALGO_RNK = _jsgd_wrap.JSGD_ALGO_RNK
JSGD_ALGO_WAR = _jsgd_wrap.JSGD_ALGO_WAR
JSGD_ALGO_LOG = _jsgd_wrap.JSGD_ALGO_LOG
JSGD_ALGO_STF = _jsgd_wrap.JSGD_ALGO_STF
JSGD_ALGO_SQR = _jsgd_wrap.JSGD_ALGO_SQR
JSGD_AVG_NONE = _jsgd_wrap.JSGD_AVG_NONE
JSGD_AVG_WGT = _jsgd_wrap.JSGD_AVG_WGT
JSGD_AVG_OPT = _jsgd_wrap.JSGD_AVG_OPT
